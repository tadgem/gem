...
protected:
    ...
    static void update_gamepad_button(int gamepad_index, gamepad_button b, bool value);
    static void update_gamepad_trigger(int gamepad_index, gamepad_trigger b, float value);
