...
namespace gem {
	...
	public:
		...
		std::vector<entity>		create_entity_from_model(asset_handle model_asset_handle, model& model_to_load, asset_handle shader_asset_handle, shader& material_shader, glm::vec3 scale = glm::vec3(1.0f), glm::vec3 euler = glm::vec3(0.0f), std::map<std::string, texture_map_type> known_maps = {});
