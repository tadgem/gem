...
void gl_renderer::init(asset_manager &am) {
  ...
  am.load_asset("assets/shaders2/voxel_cone_tracing.shader",
                asset_type::shader);
...
void gl_renderer::on_imgui(asset_manager &am) {
  ...
  ImGui::Text("Application average %.3f ms/frame (%.1f FPS)",
              1000.0f / gl_backend::s_imgui_io->Framerate,
              gl_backend::s_imgui_io->Framerate);
